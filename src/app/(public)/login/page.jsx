...
export const metadata = {
  title: 'Login — Fable',
  description: 'Continue your reading journey with Fable.',
};
      ...
      <div className="relative hidden w-1/2 overflow-hidden lg:flex">
        ...
        <div className="relative z-10 flex w-full flex-col justify-between p-14">
          ...
          <div className="max-w-md">
            {/* open book line-art illustration */}
            <svg
              width="220"
              height="140"
              viewBox="0 0 220 140"
            ...
            >
              <path
                d="M10 20C40 8 75 8 108 22V120C75 106 40 106 10 118V20Z"
                stroke="currentColor"
                strokeOpacity="0.5"
                strokeWidth="1.5"
              />
              <path
                d="M210 20C180 8 145 8 112 22V120C145 106 180 106 210 118V20Z"
                stroke="currentColor"
                strokeOpacity="0.5"
                strokeWidth="1.5"
              />
            ...
            <p className="mt-4 text-sm text-[var(--text-secondary)]">
              Join a home for original ebooks, emerging writers, and readers
