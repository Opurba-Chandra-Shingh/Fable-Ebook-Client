...
const NAV_ITEMS = [
  { label: 'Overview', href: '/dashboard/writer', icon: LayoutGrid },
  { label: 'My Ebooks', href: '/dashboard/writer/ebooks', icon: Library },
  { label: 'Add Ebook', href: '/dashboard/writer/ebooks/new', icon: PlusCircle },
  { label: 'Sales', href: '/dashboard/writer/sales', icon: LineChart },
  { label: 'Bookmarks', href: '/dashboard/writer/bookmarks', icon: Bookmark },
  { label: 'Profile', href: '/dashboard/writer/profile', icon: UserCircle },
];
